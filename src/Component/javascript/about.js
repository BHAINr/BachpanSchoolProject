...
import './AboutSection.css'; // Optional: if you want to add custom CSS
import pic1 from './images/about.2.png'
import pic2 from './images/about1.png'
import pic3 from './images/about3.jpg'
import pic4 from './images/about4.jpg'
import pic5 from './images/aboutt.jpg'
                            ...
                            <div className="row g-4 align-items-center">
                                <div className="col-sm-6">
                                    <div className="d-flex align-items-center">
                                        <img className="rounded-circle flex-shrink-0" src={pic1} alt="" style={{ width: '45px', height: '45px' }} />
                                        <div className="ms-3">
                        ...
                        <div className="row g-0">
                            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s" style={{ minHeight: '400px' }}>
                                <div className="position-relative h-100">
                                    <img className="position-absolute w-100 h-100 rounded" src={pic5} style={{ objectFit: 'cover' }} alt="" />
                                </div>
                            </div>
